	...
	<TBODY>
		<TR vAlign=top>
			...
			<table width="90%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="90" height="90" valign="top"><img
						src="${requestScope.currdish.img}" border="0" width="80" height="80"></td>
					<td valign="top">
					<table width="98%" border="0" cellspacing="1" cellpadding="0"
						align="center">
						<tr>
							<td><strong>${requestScope.currdish.dishname}</strong></td>
						</tr>
						<tr>
							<td height="21">原价：<strike>人民币0元</strike><br>
							<font color="#ff0000">现价：人民币${requestScope.currdish.price}元</font><br>
							${requestScope.currdish.dishdesc}</td>
						</tr>
					</table>
					</td>
				</tr>
				<tr>
					<td height="30">编号:${requestScope.currdish.dishid}</td>
					<td>
					<table width="145" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td align="center" width="70"><a href="LoginServlet?op=addtocart&dishid=${currdish.dishid}" target=_blank>
                            <img
			...
			<P align=center><IMG
				...
				height=294 alt="" hspace=0 src="${requestScope.currdish.img}" width=350
				border=0></P>
			<P align=center><FONT size=3>${requestScope.currdish.dishdesc}</FONT></P>
			<br>
			</td>
		</tr>
</table>
